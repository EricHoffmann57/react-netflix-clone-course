            ...
            <div className="overlay">
                <div className="titleData">
                    <h2 className="movieName">
                        {movieName?.split(` `)?.length > 1 ? movieSplit?.length > 17 ? truncate(movieSplit, 25) : movieName?.length > 17 ? truncate(movieName, 25) : truncate(movieSplit, 25) : truncate(movieName, 25)}
                    </h2>
                    <div className="data">
                ...
                <div className="movieDescription">
                    ...
                    </div> : movieName?.length > 19 ? truncate(movie?.overview, 135) : truncate(movie?.overview, 175)}
                </div>
