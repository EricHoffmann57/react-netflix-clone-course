          ...
          >
            <ul className='drawerDash'>
                <Link to={'/'}>
                    <a title="Home" className="homeLink" href="./">
                        <LazyLoadImage effect="blur" src={`/public/assets/netflixLogo.png`} id={`logo`} className="logo" alt={`logo`} width={`120px`} height={`auto`} />
                    </a>
                </Link>
            ...
            <div className="drawerDash drawerFooter">
                <div className="nameText">
                    <a className="customLink hoverLink" href="https://github.com/EricHoffmann57/react-netflix-clone-course.git" title="reat-netflix-clone-course"><i className="fab fa-github"></i> Netflix Clone</a>
                </div>
